...
var initialSrc = "assets/img/digemerge_logo.png";
var scrollSrc = "assets/img/digemerge_logo.png";

var initialSrc2 = "../assets/img/digemerge_logo.html";
var scrollSrc2 = "../assets/img/digemerge_logo.html";
...
/*---------------------
  ...
  // Rtl Home 1 hero Slider

  if ($('.hero-slide2').length > 0) {

    $(window).on('load', function() {
        $('.hero-slide2').on('init', function(e, slick) {
            var $firstAnimatingElements = $('.slide:first-child').find('[data-animation]');
            doAnimations($firstAnimatingElements);
        });
        $('.hero-slide2').on('beforeChange', function(e, slick, currentSlide, nextSlide) {
            var $animatingElements = $('.slide[data-slick-index="' + nextSlide + '"]').find('[data-animation]');
            doAnimations($animatingElements);
        });
 ...
 if ($('body').find('#clockdiv').length !== 0) {
    ...
    var deadline = new Date("10Sep, 2020 19:37:25"); 
